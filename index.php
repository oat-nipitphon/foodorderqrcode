...
<div class="row">
        ...
        <div class="container mx-auto">
            <div class="sm:pb-60 sm:pt-48 py-20">
                <div class="bg-black bg-opacity-70 p-12 mb-5 text-center mx-auto" style="width:40%;">
                    <h3 class="text-white text-4xl tm-logo-font mb-5">ระบบสั่งอาหารด้วย QR Code</h3>
                </div>    
                ...
                <div class="text-center" style="margin-top:150px;">
                    <div class="inline-block mx-auto">
                        <a href="selecttable.php" class="bg-black bg-opacity-70 py-6 px-8 rounded-lg font-semibold tm-text-2xl tm-text-gold hover:text-gray-200 transition">
                            <i class="fas fa-coffee mr-3"></i>
                            <span>เลือกโต๊ะ</span>                        
                        </a>
                    </div>
                    <div class="inline-block mx-auto">
                        <a href="#menu" class="bg-black bg-opacity-70 py-6 px-8 rounded-lg font-semibold tm-text-2xl tm-text-gold hover:text-gray-200 transition">
                            <i class="fas fa-coffee mr-3"></i>
